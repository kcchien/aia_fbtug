...
ARGS = {
    'graph':'built_graph/yolov2-tiny-farmbot.graph',
    'image':'pepper.jpg',
    'dim':[416, 416]
}
...
def infer_image(graph, input_fifo, output_fifo, img, frame):
    ...
    for i in range(len(nms_predictions)):
        ...
        print('aia#' + best_class_name+ '#' + str(confidence)+ '#' + str(np.sum(inference_time)) + '#' + str(center_x) + '#' + str(center_y) + '#' + str(xmin) + '#' + str(ymax) )
